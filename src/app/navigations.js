export const navigations = [
  ...
  // { name: "Score Board", path: "/auction/scoreboard", icon: "casino" },
  // { name: "Sign In", path: "/auction/signIn", icon: "desktop_mac" },
  // { name: "demoo", path: "/ademo/demoo", icon: "dashboard" },
  // { name: "Add Auction", path: "/auction/addauction", icon: "dashboard" },
